...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < x.length; i++) {
            x[i] = i + 1;
            //Мат.формула синусоидального калибания амплитуда умножить на синус.фунцкицю с частотой и сдвигом
            y[i] = 3.0  * Math.sin(x[i]) + 3;//Последня цифра - сдвиг графика относительно шкалы y
